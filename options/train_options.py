...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--image_affix', type=str, default='jpg', help='choose image type')
        parser.add_argument('--label_affix', type=str, default='png', help='choose label type')
        parser.add_argument('--nepoch', type=int, default=150, help='maximum epochs')
